	...
	Попытка
		...
		Если Не Отказ Тогда
			...
			Если Не Отказ Тогда
				...
				//АЯН
				Если Комментарий = "аян_ВыгрузкаИзРегистрации" Тогда
					аян_ОбработатьПравилаВыгрузки();		
				Иначе
...
Функция аян_ОбработатьПравилаВыгрузки()
	...
	Иначе
		//По данным
		УдачнаяВыгрузка = аян_ВыполнитьВыгрузкуПоДанным();
	КонецЕсли;
...
//   Данные - ЛюбаяСсылка - ссылка справочника, документа, ключ регистра сведений и т.д.
//
Процедура аян_ПолучитьСтрокуПравилВыгрузкиПоОбъектуОбмена(ТекДанные, МетаданныеПоследнегоОбъекта, МетаданныеОбъектаВыгрузки, 
	...
	Если СтруктураДанных = Неопределено Тогда
		...
		//Если МетаданныеПоследнегоОбъекта <> МетаданныеОбъектаВыгрузки Тогда
		//
		//	ТекущаяСтрокаПравилаВыгрузки = аян_НайтиСтрокуМассиваПравилКонвертацииПоТипуВыгрузки(МассивПравилКонвертации, Тип("КонстантыНабор"));
		//	
		//Иначе
		//	
		//	ТекущаяСтрокаПравилаВыгрузки = ПоследняяСтрокаПравилВыгрузки;
	...
	Если СтруктураДанных.ЭтоСсылочныйТип = Истина Тогда
		...
		//Если МетаданныеПоследнегоОбъекта <> МетаданныеОбъектаВыгрузки Тогда
		//
		//	ТекущаяСтрокаПравилаВыгрузки = аян_НайтиСтрокуМассиваПравилКонвертацииПоТипуВыгрузки(МассивПравилКонвертации, СтруктураДанных.ТипСсылки);
		//	
		//Иначе
		//	
		//	ТекущаяСтрокаПравилаВыгрузки = ПоследняяСтрокаПравилВыгрузки;
...
&НаСервере
Процедура аян_ЗаполнитьПараметры(Ключ, Значение)
...
Функция аян_ВыполнитьВыгрузкуПоДанным()
	...
	Попытка
		...
		Для каждого Стр Из СоответвиеПараметровВыгрузки Цикл
			...
			ТипСсылки = Стр.Ключ;
			ОбъектДляПравилВыгрузки = Стр.Значение;
			
			//ПередачаПараметров
			аян_ЗаполнитьПараметры("ТипСсылки", ТипСсылки);
			аян_ЗаполнитьПараметры("МассивСсылок1С", ОбъектДляПравилВыгрузки);
