...
//		"ТЗ" - ТаблицаЗначений
Функция ДанныеИБПоСсылкам(МассивСсылокНаОбъект, ПоляЗаполнения, ИмяТипа = "", ВидРезультата = "ВДЗ")  Экспорт
	...
	Попытка
		...
		Если ИмяТипа = "" Тогда
			Если ТипЗнч(МассивСсылокНаОбъект) = пр_НастройкиПовтИсп.ТипМассив() Тогда
				ИмяТипа = XMLТипЗнч(МассивСсылокНаОбъект[0]).ИмяТипа;
			Иначе
				ИмяТипа = XMLТипЗнч(МассивСсылокНаОбъект).ИмяТипа;
			КонецЕсли; 
		КонецЕсли; 
